...
download_receitas <- function(anos_f, lista_municipios_f) {
 ...
 getwd() # "C:/Users/carlo/Desktop/RProjet_workspace/Observatorio_ODS_LN")
  
  tipo = "receitas"
  receitas_acum <- read.csv(file = "receitas_vazia.csv", sep = ";", header = T, encoding = "latin1")

    # opção para juntar arquivo historico existente
  # receitas_acum <- read_xlsx("Receitas-Ilhabela-2008-2024.xlsx") # opção de juntar antigo 
